...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<blockquote expandable>{filename}\n» <a href=https://t.me/Anime_sub_society>@Anime_society<a>\n »@society_network</blockquote></b>")
